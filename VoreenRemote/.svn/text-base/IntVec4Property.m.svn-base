...
#import "IntVec4Property.h"

@implementation IntVec4Property
...
- (NSString*)pythonStringParameter {
    return [NSString stringWithFormat:@"(%i,%i,%i,%i)", [self currentValueForColumn:0], [self currentValueForColumn:1], [self currentValueForColumn:2], [self currentValueForColumn:3]];
}
